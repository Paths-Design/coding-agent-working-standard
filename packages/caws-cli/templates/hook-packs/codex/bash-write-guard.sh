...
#
# CAWS Bash Write-Target Guard for Codex (WORKTREE-ISOLATION-HARDENING-001
...
# helper if present; otherwise fall back to CODEX_PROJECT_DIR.
...
AGENT_CWD="${HOOK_CWD:-${CODEX_PROJECT_DIR:-.}}"
