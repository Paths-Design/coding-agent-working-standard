...
# reset-strikes.sh — manual reset for CAWS/Codex guard strike counters.
#
...
# .codex/logs/strike-resets.log for audit.
#
...
LOG_FILE="$PROJECT_DIR/.codex/logs/strike-resets.log"
...
#   - the canonical main-repo log dir (.codex/logs)
...
collect_strike_files() {
  {
    find "$PROJECT_DIR/.codex/logs" -maxdepth 1 -name 'guard-strikes-*.json' 2>/dev/null || true
