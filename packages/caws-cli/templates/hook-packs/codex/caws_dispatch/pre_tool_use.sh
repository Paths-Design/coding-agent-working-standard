...
#
# PreToolUse dispatcher for Codex hooks.
#
# Single entry point invoked from hooks.json's PreToolUse block. Reads
...
# Codex additionalContext envelope (priority 1), so it does not
