...
# PostToolUse dispatcher for Codex hooks.
#
# Single entry point invoked from hooks.json's PostToolUse block. Reads
...
# hooks.json groups so ordering-sensitive behavior (stdout "last
